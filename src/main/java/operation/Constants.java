...
public class Constants {
    ...
    public static final Constant Vm = new Constant( "Molecular volume of an ideal gas (Vm)" ,22.710981 * Math.pow(10,-3));
    ...
    public static final Constant μh = new Constant( "Helion shield magnetic moment (μh)",-1.074553024 * Math.pow(10,-26));
    ...
    public static final Constant Nah = new Constant( "Molecular Planck's constant (Nah)", 3.990312716 * Math.pow(10,-10));

    //37. Bước sóng Compton Proton
    public static final Constant λCp = new Constant( "Compton Proton Wavelength (λCp)",1.3214098555 * Math.pow(10,-15));

    //38. Bước sóng Compton Neuton
    public static final Constant λCn = new Constant( "Compton Neutron Wavelength (λCn)",1.3195909067 * Math.pow(10,-15));
    ...
    public static final Constant G0 = new Constant( "Lượng tử độ dẫn điện (G0)",7.748091733 * Math.pow(10,-5));

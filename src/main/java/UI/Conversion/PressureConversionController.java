...
import mode.conversion.Pressure;
...
public class PressureConversionController {
    ...
    public void initChoiceBox() {
        ...
        fromUnitChoiceBox.setValue("atm");
...
//            double n = Double.parseDouble(fromUnitTextArea.getText());
            ...
            toUnitTextArea.setText(TextHandler.numberFormatter(Pressure.convert(fromUnit , toUnit , n)) + "");
        } catch (Exception e) {
            //                    e.printStackTrace();
        }
    }

...
//            double n = Double.parseDouble(fromUnitTextArea.getText());
            ...
            toUnitTextArea.setText(TextHandler.numberFormatter(Data.convert(fromUnit , toUnit , n)) + "");
        } catch (Exception e) {
            //                    e.printStackTrace();
        }
    }
